...
namespace InspectHmiFaceplateInterfaceProps
{
    class Program
    {
        ...
        static void Run()
        {
            string outFile = @"C:\Users\Admin\Documents\Automation\valveDemo2\faceplate_interface_class_properties.txt";
            using (var w = new StreamWriter(outFile))
            {
                Type type = typeof(HmiFaceplateInterface);
                w.WriteLine("=== HmiFaceplateInterface Properties ===");
